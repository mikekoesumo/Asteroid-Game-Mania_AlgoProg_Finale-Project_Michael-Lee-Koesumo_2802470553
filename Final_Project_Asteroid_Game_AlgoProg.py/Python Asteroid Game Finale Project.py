 # Asteroid Mini Game by Mike (AlgoProg Finale Project)
...
turtle.title("Asteroid Shooter Mania")
...
class Shield(turtle.Turtle):
    ...
    def draw(self):
        ...
        shield.pendown()
        if shield.strength > 60:
            shield.color("green")
            shield.pensize(3)
        elif shield.strength > 30 and shield.strength <= 60:
            shield.color("blue")
            shield.pensize(2)
        elif shield.strength > 0 and shield.strength <= 30:
            shield.color("red")
            shield.pensize(1)
        else:
            shield.color("white")
...
class Asteroid(Sprite):
    ...
    def destroy(self):
            if self.size == 3.0:
                ...
                asteroids.append(Asteroid("triangle", "blue",2.0 ,4 , self.xcor(), self.ycor()))
                ...
                self.speed = 7
                #Append a new asteroid
                asteroids.append(Asteroid("square", "blue",1.0 ,5 , self.xcor(), self.ycor()))
...
class Game():
    ...
    def start_level(self):
        for i in range(self.level):
            asteroids.append(Asteroid("circle", "green", 3.0, 2, random.randint(-300, 300), random.randint(-300, 300)))
    ...
    def show_status(self):
        ...
        self.pen.write(msg, font=("Times New Roman", 16, "normal"))

    

#Create my sprites
player = Player("triangle", "magenta", 0, 0)
